...
static const unsigned int mt6761_debounce_data[] = {
	128, 256, 512, 1024, 16384,
	32768, 65536, 131072, 262144, 524288
};

static unsigned int mt6761_spec_debounce_select(unsigned int debounce)
{
	return mtk_gpio_debounce_select(mt6761_debounce_data,
		ARRAY_SIZE(mt6761_debounce_data), debounce);
}
...
static const struct mtk_pinctrl_devdata mt6761_pinctrl_data = {
...
static int mtk_pinctrl_probe(struct platform_device *pdev)
{
	...
	ret = mtk_pctrl_init(pdev, &mt6761_pinctrl_data, NULL);
