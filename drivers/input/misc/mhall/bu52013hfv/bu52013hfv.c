...
//ADD, wangdongbo.wt_20160523
int tp_get_mhall_status = 0;
EXPORT_SYMBOL(tp_get_mhall_status);
...
static irqreturn_t hall_interrupt_handler(int irq, void *dev)
{
	...
	if(cur_mhall_eint_state == EINT_PIN_COVER){
		 ...
		 tp_get_mhall_status = EINT_PIN_LEAVE;
		...
		tp_get_mhall_status = EINT_PIN_COVER;
	}
...
*/
//bug 15842 modify for input mode
