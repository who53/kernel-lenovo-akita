...
enum ACDK_SENSOR_FEATURE_ENUM {
	SENSOR_FEATURE_BEGIN = SENSOR_FEATURE_START,	//0
	SENSOR_FEATURE_GET_RESOLUTION,			//1
	SENSOR_FEATURE_GET_PERIOD,			//2
	SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ,		//3
	SENSOR_FEATURE_SET_ESHUTTER,			//4
	SENSOR_FEATURE_SET_NIGHTMODE,			//5
	SENSOR_FEATURE_SET_GAIN,			//6
	SENSOR_FEATURE_SET_DUAL_GAIN,			//7
	SENSOR_FEATURE_SET_GAIN_AND_ESHUTTER,		//8
	SENSOR_FEATURE_SET_FLASHLIGHT,			//9
	SENSOR_FEATURE_SET_ISP_MASTER_CLOCK_FREQ,	//10
	SENSOR_FEATURE_SET_REGISTER,			//11
	SENSOR_FEATURE_GET_REGISTER,			//12
	SENSOR_FEATURE_SET_CCT_REGISTER,		//13
	SENSOR_FEATURE_GET_CCT_REGISTER,		//14
	SENSOR_FEATURE_SET_ENG_REGISTER,		//15
	SENSOR_FEATURE_GET_ENG_REGISTER,		//16
	SENSOR_FEATURE_GET_REGISTER_DEFAULT,		//17
	SENSOR_FEATURE_GET_CONFIG_PARA,			//18
	SENSOR_FEATURE_CAMERA_PARA_TO_SENSOR,		//19
	SENSOR_FEATURE_SENSOR_TO_CAMERA_PARA,		//20
	SENSOR_FEATURE_GET_GROUP_COUNT,			//21
	SENSOR_FEATURE_GET_GROUP_INFO,			//22
	SENSOR_FEATURE_GET_ITEM_INFO,			//23
	SENSOR_FEATURE_SET_ITEM_INFO,			//24
	SENSOR_FEATURE_GET_ENG_INFO,			//25
	SENSOR_FEATURE_GET_LENS_DRIVER_ID,		//26
	SENSOR_FEATURE_SET_YUV_CMD,			//27
	SENSOR_FEATURE_SET_VIDEO_MODE,			//29
	SENSOR_FEATURE_SET_TARGET_FRAME_RATE,		//30
	SENSOR_FEATURE_SET_CALIBRATION_DATA,		//31
	SENSOR_FEATURE_SET_SENSOR_SYNC,			//32
	SENSOR_FEATURE_INITIALIZE_AF,			//33
	SENSOR_FEATURE_CONSTANT_AF,			//34
	SENSOR_FEATURE_INFINITY_AF,			//35
	SENSOR_FEATURE_MOVE_FOCUS_LENS,			//36
	SENSOR_FEATURE_GET_AF_STATUS,			//37
	SENSOR_FEATURE_GET_AE_STATUS,			//38
	SENSOR_FEATURE_GET_AWB_STATUS,			//39
	SENSOR_FEATURE_GET_AF_INF,			//40
	SENSOR_FEATURE_GET_AF_MACRO,			//41
	SENSOR_FEATURE_CHECK_SENSOR_ID,			//42
	SENSOR_FEATURE_SET_AUTO_FLICKER_MODE,		//43
	SENSOR_FEATURE_SET_TEST_PATTERN,		//44
	SENSOR_FEATURE_SET_SOFTWARE_PWDN,		//45
	SENSOR_FEATURE_SINGLE_FOCUS_MODE,		//46
	SENSOR_FEATURE_CANCEL_AF,			//47
	SENSOR_FEATURE_SET_AF_WINDOW,			//48
	SENSOR_FEATURE_GET_EV_AWB_REF,			//49
	SENSOR_FEATURE_GET_SHUTTER_GAIN_AWB_GAIN,	//50
	SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS,	//51
	SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS,	//52
	SENSOR_FEATURE_SET_AE_WINDOW,			//53
	SENSOR_FEATURE_GET_EXIF_INFO,			//54
	SENSOR_FEATURE_GET_DELAY_INFO,			//55
	SENSOR_FEATURE_SET_SLAVE_I2C_ID,		//56
	SENSOR_FEATURE_SUSPEND,				//57
	SENSOR_FEATURE_RESUME,				//58
	SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO,	//59
	SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO,	//60
	SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO,		//61
	SENSOR_FEATURE_AUTOTEST_CMD,			//62
	SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE,	//63
	SENSOR_FEATURE_GET_TEMPERATURE_VALUE,		//64
	SENSOR_FEATURE_GET_SENSOR_CURRENT_TEMPERATURE,	//65
	SENSOR_FEATURE_GET_AE_FLASHLIGHT_INFO,		//66
