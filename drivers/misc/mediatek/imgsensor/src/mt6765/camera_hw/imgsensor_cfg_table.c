...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
#if defined(HI556F_MIPI_RAW)
	{
        ...
        {
                SENSOR_DRVNAME_GC5035FMIPI_RAW,
                {
...
#endif
#if defined(OV13B10S_MIPI_RAW)
        {
                SENSOR_DRVNAME_OV13B10S_MIPI_RAW,
                {
            //            {SensorMCLK, Vol_High, 0},
                        {PDN, Vol_Low, 0},
                        {RST, Vol_Low, 0},
...
#endif
#if defined(S5K4H7_QTECH_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H7_QTECH_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 1},
