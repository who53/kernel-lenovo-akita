 ...
 * Setting version:
 * ------------
 *   update full pd setting for ov13b10s_Initial version as provided by FAE
 *------------------------------------------------------------------------------
 * Upper this line, this part is controlled by CC/CQ. DO NOT MODIFY!!
 *============================================================================
 ****************************************************************************/

#define PFX "ov13b10s_camera_sensor"
...
#include "ov13b10smipiraw_Sensor.h"
...
unsigned char ov13b10_module_info_data1[MODULE_INFO_SIZE + 3] = {0}; //Additional : 1 - Flag & 2- Checksum
unsigned char ov13b10_ofilm_af_data1[AF_DATA_SIZE + 3] = {0};//Additional : 1 - Flag & 2- Checksum
unsigned char ov13b10_ofilm_awb_data1[AWB_DATA_SIZE + 3] = {0};//Additional : 1 - Flag & 2- Checksum
unsigned char ov13b10_ofilm_lsc_data1[LSC_DATA_SIZE + 3] = {0};//Additional : 1 - Flag & 2- Checksum
unsigned char ov13b10_ofilm_pdaf_data1[PDAF_DATA_SIZE + 5] = {0};//Additional : 1 - Flag & 5- Checksum

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10S_SENSOR_ID,
...
static kal_uint16 ov13b10s_table_write_cmos_sensor(
...
static int read_module_info_data(void)
{
    ...
    pr_err("GANIDRV_S: %s Start", __func__);
    ...
    for(i = START_ADDR_INFO_DATA; i <= END_ADDR_INFO_DATA; i++){
        ov13b10_module_info_data1[i] = read_cmos_sensor(i);
    }
    ...
    for(i = 0; i < MODULE_INFO_SIZE + 3; i++){
      pr_debug("GANIDRV_S: pos[%d] --> %x", i, ov13b10_module_info_data1[i]);
    }

    return ov13b10_module_info_data1[0x0b];//module id
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10s[] = { //Values provided by OmniVision FAE - LingLing
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10s_table_write_cmos_sensor(
			addr_data_pair_init_ov13b10s,
			sizeof(addr_data_pair_init_ov13b10s) / sizeof(kal_uint16));
#else
	LOG_INF("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10s[] = { //Values provided by Oflin FAE - LingLing
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x10,
	0x3662, 0x88,
...
#if MULTI_WRITE
	ov13b10s_table_write_cmos_sensor(
			addr_data_pair_preview_ov13b10s,
			sizeof(addr_data_pair_preview_ov13b10s) / sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10s[] = { 
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10s[] = { //Values provided by Oflin FAE - LingLing
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) { 
		ov13b10s_table_write_cmos_sensor(
				addr_data_pair_capture_15fps_ov13b10s,
				sizeof(addr_data_pair_capture_15fps_ov13b10s) /
				sizeof(kal_uint16));
	} else {
		ov13b10s_table_write_cmos_sensor(
				addr_data_pair_capture_30fps_ov13b10s,
				sizeof(addr_data_pair_capture_30fps_ov13b10s) /
				sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10s[] = {
...
#if MULTI_WRITE
	ov13b10s_table_write_cmos_sensor(
			addr_data_pair_video_ov13b10s,
			sizeof(addr_data_pair_video_ov13b10s) /
			sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0303, 0x00);
	write_cmos_sensor(0x3501, 0x80);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10s[] = {
	0x305,0x23, 
	0x3501,0x3,  
	0x3502,0x0,  
	0x3662,0x88, 
...
#if MULTI_WRITE
	ov13b10s_table_write_cmos_sensor(
			addr_data_pair_hs_video_ov13b10s,
			sizeof(addr_data_pair_hs_video_ov13b10s) /
			sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10s[] = {
	0x305,   23, 
	0x3501, 0x2,  
	0x3502, 0x0,  
	0x3662, 0x84, 
...
#if MULTI_WRITE
	ov13b10s_table_write_cmos_sensor(
			addr_data_pair_slim_video_ov13b10s,
			sizeof(addr_data_pair_slim_video_ov13b10s) /
			sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0303, 0x03);//PLL
	write_cmos_sensor(0x3501, 0x20);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
	    ...
	    *sensor_id = 0xFFFFFFFF;
            LOG_INF("ov13b10s get_imgsensor_id fail module is not Qtech\n");
...
UINT32 OV13B10S_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
