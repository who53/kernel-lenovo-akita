...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->backlight_cust[0].max_bl_lvl = 777;
	...
	//params->use_gpioID = 1;
	//params->gpioID_value = 0; //id0 = 0, id1 = 0 (lcd_id0 | (lcd_id1 << 2))
}

static void lcm_init_power(void)
{
	pr_err("[LCM][GPIO]lcm_init_power !\n");
	lcm_power_enable_vdd3();
}
...
static void lcm_init(void)
{
	...
	LCM_LOGI("nt51021b---lcm mode = vdo mode ----\n");
}
...
#if (LCM_DSI_CMD_MODE)
struct LCM_DRIVER nt51021b_wuxga_cmd_oncell_auo_lcm_drv = {
	.name = "nt51021b_wuxga_cmd_oncell_auo",
#else

struct LCM_DRIVER nt51021b_wuxga_vdo_oncell_auo_lcm_drv = {
	.name = "nt51021b_wuxga_vdo_oncell_auo",
#endif
