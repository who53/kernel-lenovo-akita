...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->backlight_cust[0].max_bl_lvl = 818;	//818 20mA, 859 21mA
...
#if (LCM_DSI_CMD_MODE)
struct LCM_DRIVER ft8201_wxga_cmd_incell_inx_lcm_drv = {
	.name = "ft8201_wxga_cmd_incell_inx",
#else

struct LCM_DRIVER ft8201_wxga_vdo_incell_inx_lcm_drv = {
	.name = "ft8201_wxga_vdo_incell_inx",
#endif
