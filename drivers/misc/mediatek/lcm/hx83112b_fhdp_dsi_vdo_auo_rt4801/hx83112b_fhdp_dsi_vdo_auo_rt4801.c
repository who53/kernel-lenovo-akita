...
static struct LCM_setting_table_V3 lcm_aod_in_setting_v3[] = {
	{REGFLAG_ESCAPE_ID, 0xB9, 0x03, {0x83, 0x11, 0x2B} },
	{REGFLAG_ESCAPE_ID, 0xB1, 0x0A, {0xF8, 0x29, 0x29,
						0x00, 0x00, 0x0F, 0x14, 0x0F,
						0x14, 0x33} },
	{REGFLAG_ESCAPE_ID, 0xD2, 0x02, {0x2C, 0x2C} },
	{REGFLAG_ESCAPE_ID, 0xB2, 0x0B, {0x80, 0x02, 0x00,
						0x80, 0x70, 0x00, 0x08, 0x1C,
						0x05, 0x01, 0x04} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0xD1} },
	{REGFLAG_ESCAPE_ID, 0xB2, 0x02, {0x00, 0x08} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0xCE} },
	{REGFLAG_ESCAPE_ID, 0xB2, 0x01, {0xA3} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x02} },
	{REGFLAG_ESCAPE_ID, 0xB2, 0x02, {0xB5, 0x0A} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xDD, 0x08, {0x00, 0x00, 0x08,
						0x1C, 0x09, 0x34, 0x34, 0x8B} },
	{REGFLAG_ESCAPE_ID, 0xB4, 0x18, {0x01, 0xD3, 0x00,
						0x00, 0x00, 0x00, 0x03, 0xD0,
						0x00, 0x00, 0x0F, 0xCB, 0x01,
						0x00, 0x00, 0x13, 0x00, 0x2E,
						0x08, 0x01, 0x12, 0x00, 0x00,
						0x2E} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x02} },
	{REGFLAG_ESCAPE_ID, 0xB4, 0x01, {0x92} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xB6, 0x03, {0x81, 0x81, 0xE3} },
	{REGFLAG_ESCAPE_ID, 0xC0, 0x01, {0x44} },
	{REGFLAG_ESCAPE_ID, 0xCC, 0x01, {0x08} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x03} },
	{REGFLAG_ESCAPE_ID, 0xC1, 0x39, {0xFF, 0xFA, 0xF6,
						0xF3, 0xEF, 0xEB, 0xE7, 0xE0,
						0xDC, 0xD9, 0xD6, 0xD2, 0xCF,
						0xCB, 0xC7, 0xC3, 0xBF, 0xBB,
						0xB7, 0xB0, 0xA8, 0xA1, 0x9A,
						0x92, 0x89, 0x81, 0x7A, 0x73,
						0x6B, 0x63, 0x5A, 0x51, 0x48,
						0x40, 0x38, 0x31, 0x29, 0x20,
						0x16, 0x0D, 0x09, 0x07, 0x05,
						0x02, 0x00, 0x08, 0x2E, 0xF6,
						0x20, 0x18, 0x94, 0xF8, 0x6F,
						0x59, 0x18, 0xFC, 0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x02} },
	{REGFLAG_ESCAPE_ID, 0xC1, 0x39, {0xFF, 0xFA, 0xF6,
						0xF3, 0xEF, 0xEB, 0xE7, 0xE0,
						...
						0x20, 0x18, 0x94, 0xF8, 0x6F,
						0x59, 0x18, 0xFC, 0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x01} },
	{REGFLAG_ESCAPE_ID, 0xC1, 0x39, {0xFF, 0xFA, 0xF6,
						0xF3, 0xEF, 0xEB, 0xE7, 0xE0,
						0xDC, 0xD9, 0xD6, 0xD2, 0xCF,
						0xCB, 0xC7, 0xC3, 0xBF, 0xBB,
						...
						0x59, 0x18, 0xFC, 0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xC1, 0x01, {0x01} },
	{REGFLAG_ESCAPE_ID, 0xD3, 0x16, {0x01, 0x00, 0x00,
						0x00, 0x00, 0x01, 0x01, 0x0A,
						0x0A, 0x07, 0x00, 0x00, 0x08,
						0x09, 0x09, 0x09, 0x09, 0x32,
						0x10, 0x09, 0x00, 0x09} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0xE3} },
	{REGFLAG_ESCAPE_ID, 0xD3, 0x03, {0x05, 0x08, 0x86} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x01} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0xC8} },
	{REGFLAG_ESCAPE_ID, 0xD3, 0x01, {0x81} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xD5, 0x30, {0x18, 0x18, 0x18,
						0x18, 0x18, 0x18, 0x18, 0x18,
						0x31, 0x31, 0x30, 0x30, 0x2F,
						0x2F, 0x31, 0x31, 0x30, 0x30,
						0x2F, 0x2F, 0xC0, 0x18, 0x40,
						0x40, 0x01, 0x00, 0x07, 0x06,
						0x05, 0x04, 0x03, 0x02, 0x21,
						0x20, 0x18, 0x18, 0x19, 0x19,
						0x18, 0x18, 0x03, 0x03, 0x18,
						0x18, 0x18, 0x18, 0x18, 0x18} },
	{REGFLAG_ESCAPE_ID, 0xD6, 0x30, {0x18, 0x18, 0x18,
						0x18, 0x18, 0x18, 0x18, 0x18,
						0x31, 0x31, 0x30, 0x30, 0x2F,
						0x2F, 0x31, 0x31, 0x30, 0x30,
						0x2F, 0x2F, 0xC0, 0x18, 0x40,
						0x40, 0x02, 0x03, 0x04, 0x05,
						0x06, 0x07, 0x00, 0x01, 0x20,
						0x21, 0x18, 0x18, 0x18, 0x18,
						0x19, 0x19, 0x20, 0x20, 0x18,
						0x18, 0x18, 0x18, 0x18, 0x18} },
	{REGFLAG_ESCAPE_ID, 0xD8, 0x18, {0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00,
						0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x01} },
	{REGFLAG_ESCAPE_ID, 0xD8, 0x18, {0xAA, 0xAA, 0xAA,
						...
						0xAA} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x02} },
	{REGFLAG_ESCAPE_ID, 0xD8, 0x0C, {0xAF, 0xFF, 0xFA,
						0xAA, 0xBA, 0xAA, 0xAA, 0xFF,
						0xFA, 0xAA, 0xBA, 0xAA} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x03} },
	{REGFLAG_ESCAPE_ID, 0xD8, 0x18, {0xAA, 0xAA, 0xAB,
						0xAA, 0xAE, 0xAA, 0xAA, 0xAA,
						0xAB, 0xAA, 0xAE, 0xAA, 0xAA,
						0xFF, 0xFA, 0xAA, 0xBA, 0xAA,
						0xAA, 0xFF, 0xFA, 0xAA, 0xBA,
						0xAA} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xE7, 0x19, {0x09, 0x09, 0x00,
						0x07, 0xE6, 0x00, 0x27, 0x00,
						0x07, 0x00, 0x00, 0xE6, 0x2A,
						0x00, 0xE6, 0x00, 0x0A, 0x00,
						0x00, 0x00, 0x01, 0x01, 0x00,
						0x12, 0x04} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0xE4} },
	{REGFLAG_ESCAPE_ID, 0xE7, 0x02, {0x17, 0x69} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x01} },
	{REGFLAG_ESCAPE_ID, 0xE7, 0x09, {0x02, 0x00, 0x01,
						0x20, 0x01, 0x0E, 0x08, 0xEE,
						0x09} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x02} },
	{REGFLAG_ESCAPE_ID, 0xE7, 0x03, {0x20, 0x20, 0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x03} },
	{REGFLAG_ESCAPE_ID, 0xE7, 0x06, {0x00, 0x08, 0x01,
						0x00, 0x00, 0x20} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0xC9} },
	{REGFLAG_ESCAPE_ID, 0xE7, 0x02, {0x2E, 0xCB} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xD1, 0x01, {0x27} },
	{REGFLAG_ESCAPE_ID, 0xBC, 0x01, {0x07} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x01} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0xC2} },
	{REGFLAG_ESCAPE_ID, 0xCB, 0x01, {0x27} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0x51, 0x02, {0x0F, 0xFF} },
	{REGFLAG_ESCAPE_ID, 0x53, 0x01, {0x24} },
	{REGFLAG_ESCAPE_ID, 0x55, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0x35, 0x01, {0x00} },
	/* set TE event @ line 0x866(2150) */
	{REGFLAG_ESCAPE_ID, 0x44, 2, {0x08, 0x66} },
	{REGFLAG_ESCAPE_ID, 0x11, 0, {} },
	{REGFLAG_ESCAPE_ID, REGFLAG_DELAY_MS_V3, 10, {} },

	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0xC2} },
	{REGFLAG_ESCAPE_ID, 0xB0, 0x01, {0x01} },
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
...
static struct LCM_setting_table_V3 lcm_aod_out_setting_v3[] = {
	...
	{REGFLAG_ESCAPE_ID, 0xB6, 0x03, {0x81, 0x81, 0xE3} },
	{REGFLAG_ESCAPE_ID, 0xC0, 0x01, {0x44} },
	{REGFLAG_ESCAPE_ID, 0xC2, 0x01, {0x83} },
	{REGFLAG_ESCAPE_ID, 0xCC, 0x01, {0x08} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x03} },
	{REGFLAG_ESCAPE_ID, 0xC1, 0x39, {0xFF, 0xFA, 0xF6,
						0xF3, 0xEF, 0xEB, 0xE7, 0xE0,
	...
	{REGFLAG_ESCAPE_ID, 0xE9, 0x01, {0x00} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x01} },
	{REGFLAG_ESCAPE_ID, 0xE7, 0x09, {0x00, 0x00, 0x01,
						0x20, 0x01, 0x0E, 0x08, 0xEE,
						0x09} },
	{REGFLAG_ESCAPE_ID, 0xBD, 0x01, {0x02} },
	{REGFLAG_ESCAPE_ID, 0xE7, 0x03, {0x20, 0x20, 0x00} },
...
static void lcm_sleep_in(void)
{
	dsi_set_cmdq_V4(lcm_sleep_in_setting_v3,
...
static void lcm_aod(int enter)
{
	...
	SET_RESET_PIN(1);
	if (enter) {
		dsi_set_cmdq_V4(lcm_aod_in_setting_v3,
			ARRAY_SIZE(lcm_aod_in_setting_v3), 0);
	} else {
		dsi_set_cmdq_V4(lcm_aod_out_setting_v3,
			ARRAY_SIZE(lcm_aod_out_setting_v3), 0);
	}
}
