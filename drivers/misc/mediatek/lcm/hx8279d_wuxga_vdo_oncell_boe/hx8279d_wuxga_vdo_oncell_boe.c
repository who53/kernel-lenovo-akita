...
static struct LCM_setting_table init_setting_vdo[] = {
	{REGFLAG_DELAY,2,{}},/*{0x10,0,{}},{REGFLAG_DELAY,10,{}},*/
	{0xB0 ,0x01,{0x00}},{0xB8 ,0x01,{0x00}},{0xB0 ,0x01,{0x05}},//{REGFLAG_DELAY,10,{}},
	...
	{0xB0 ,0x01,{0x07}},{0xB1 ,0x01,{0x08}},{0xB2 ,0x01,{0x09}},
	{0xB3 ,0x01,{0x1A}},{0xB4 ,0x01,{0x36}},{0xB5 ,0x01,{0x53}},
	{0xB6 ,0x01,{0x6C}},{0xB7 ,0x01,{0x94}},{0xB8 ,0x01,{0xB7}},
	{0xB9 ,0x01,{0xF6}},{0xBA ,0x01,{0x32}},{0xBB ,0x01,{0x9E}},
	{0xBC ,0x01,{0x0C}},{0xBD ,0x01,{0x10}},{0xBE ,0x01,{0x96}},
	{0xBF ,0x01,{0x1D}},{0xC0 ,0x01,{0x5E}},{0xC1 ,0x01,{0xA0}},
	{0xC2 ,0x01,{0xBB}},{0xC3 ,0x01,{0xD4}},{0xC4 ,0x01,{0xE0}},
	{0xC5 ,0x01,{0xEB}},{0xC6 ,0x01,{0xF7}},{0xC7 ,0x01,{0xFA}},
	...
	{0xB2 ,0x01,{0x07}},{0xB3 ,0x01,{0x16}},{0xB4 ,0x01,{0x36}},
	{0xB5 ,0x01,{0x53}},{0xB6 ,0x01,{0x6D}},{0xB7 ,0x01,{0x96}},
	{0xB8 ,0x01,{0xB8}},{0xB9 ,0x01,{0xF7}},{0xBA ,0x01,{0x34}},
	{0xBB ,0x01,{0xA0}},{0xBC ,0x01,{0x10}},{0xBD ,0x01,{0x14}},
	{0xBE ,0x01,{0x99}},{0xBF ,0x01,{0x21}},{0xC0 ,0x01,{0x61}},
	{0xC1 ,0x01,{0xA2}},{0xC2 ,0x01,{0xBD}},{0xC3 ,0x01,{0xD5}},
	{0xC4 ,0x01,{0xE1}},{0xC5 ,0x01,{0xEC}},{0xC6 ,0x01,{0xF7}},
	...
	{0xB1 ,0x01,{0x04}},{0xB2 ,0x01,{0x11}},{0xB3 ,0x01,{0x18}},
	{0xB4 ,0x01,{0x37}},{0xB5 ,0x01,{0x54}},{0xB6 ,0x01,{0x6E}},
	{0xB7 ,0x01,{0x97}},{0xB8 ,0x01,{0xB9}},{0xB9 ,0x01,{0xF8}},
	{0xBA ,0x01,{0x35}},{0xBB ,0x01,{0xA2}},{0xBC ,0x01,{0x13}},
	{0xBD ,0x01,{0x17}},{0xBE ,0x01,{0x9C}},{0xBF ,0x01,{0x24}},
	{0xC0 ,0x01,{0x64}},{0xC1 ,0x01,{0xA3}},{0xC2 ,0x01,{0xBE}},
	{0xC3 ,0x01,{0xD6}},{0xC4 ,0x01,{0xE2}},{0xC5 ,0x01,{0xEC}},
	{0xC6 ,0x01,{0xF7}},{0xC7 ,0x01,{0xFA}},{0xC8 ,0x01,{0xFC}},
	{0xC9 ,0x01,{0x00}},{0xCA ,0x01,{0x00}},{0xCB ,0x01,{0x16}},
	{0xCC ,0x01,{0xAF}},{0xCD ,0x01,{0xFF}},{0xCE ,0x01,{0xFF}},
	{0xB0 ,0x01,{0x0A}},{0xB1 ,0x01,{0x08}},{0xB2 ,0x01,{0x09}},
	{0xB3 ,0x01,{0x1A}},{0xB4 ,0x01,{0x36}},{0xB5 ,0x01,{0x53}},
	{0xB6 ,0x01,{0x6C}},{0xB7 ,0x01,{0x94}},{0xB8 ,0x01,{0xB7}},
	{0xB9 ,0x01,{0xF6}},{0xBA ,0x01,{0x32}},{0xBB ,0x01,{0x9E}},
	{0xBC ,0x01,{0x0C}},{0xBD ,0x01,{0x10}},{0xBE ,0x01,{0x96}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.lcm_esd_check_table[0].cmd = 0xBF;
	params->dsi.lcm_esd_check_table[0].count = 1;
	params->dsi.lcm_esd_check_table[0].para_list[0] = 0x24;
	params->dsi.lcm_esd_check_table[0].page_cmd = 0xB0;
	params->dsi.lcm_esd_check_table[0].page_count = 1;
	params->dsi.lcm_esd_check_table[0].page_para_list[0] = 0x0C;

	params->dsi.lcm_esd_check_table[1].cmd = 0xD7;
	params->dsi.lcm_esd_check_table[1].count = 1;
	params->dsi.lcm_esd_check_table[1].para_list[0] = 0x08;
	params->dsi.lcm_esd_check_table[1].page_cmd = 0xB0;
	params->dsi.lcm_esd_check_table[1].page_count = 1;
	params->dsi.lcm_esd_check_table[1].page_para_list[0] = 0x01;

	params->dsi.lcm_esd_check_table[2].cmd = 0xD6;
	params->dsi.lcm_esd_check_table[2].count = 1;
	params->dsi.lcm_esd_check_table[2].para_list[0] = 0x88;
	params->dsi.lcm_esd_check_table[2].page_cmd = 0xB0;
	params->dsi.lcm_esd_check_table[2].page_count = 1;
	params->dsi.lcm_esd_check_table[2].page_para_list[0] = 0x03;

	params->backlight_cust_count=1;
	params->backlight_cust[0].max_brightness = 255;
	params->backlight_cust[0].min_brightness = 10;
	params->backlight_cust[0].max_bl_lvl = 818;
	params->backlight_cust[0].min_bl_lvl = 10;
	...
	//params->use_gpioID = 1;
	//params->gpioID_value = 1; //id0 = 1, id1 = 0 (lcd_id0 | (lcd_id1 << 2))
}

static void lcm_init_power(void)
{
	pr_err("[LCM][GPIO]lcm_init_power !\n");
	//lcm_power_enable_fhd();
}
...
static void lcm_init(void)
{
	...
	LCM_LOGI("hx8279d---lcm mode = vdo mode ----\n");
}
...
#if (LCM_DSI_CMD_MODE)
struct LCM_DRIVER hx8279d_wuxga_cmd_oncell_boe_lcm_drv = {
	.name = "hx8279d_wuxga_cmd_oncell_boe",
#else

struct LCM_DRIVER hx8279d_wuxga_vdo_oncell_boe_lcm_drv = {
	.name = "hx8279d_wuxga_vdo_oncell_boe",
#endif
