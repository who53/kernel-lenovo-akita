...
static int pmic_ldo_vaud18_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vaud18 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vaud18_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vaud18 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vaud18_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vaud18 don't have da_en_cb\n");
		return -1;
	}
...
static int pmic_buck_vgpu11_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("buck vgpu11 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_buck_vgpu11_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("buck vgpu11 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_buck_vgpu11_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("buck vgpu11 don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("buck vgpu11 don't have vol_cb\n");
		ret = -1;
	}
...
static int pmic_buck_vgpu11_get_voltage_sel(struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("buck vgpu11 don't have da_vol_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vrf12 don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vrf12 don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vsram_proc2_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vsram_proc2 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vsram_proc2_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vsram_proc2 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vsram_proc2_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vsram_proc2 don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vsram_proc2 don't have vol_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vsram_proc2_get_voltage_sel(struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vsram_proc2 don't have da_vol_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vio18 don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vio18 don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vcamio don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vcamio don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vcn13_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vcn13 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vcn13_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vcn13 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vcn13_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vcn13 don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vcn13 don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vcn13 don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vcn33_1_bt_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vcn33_1_bt don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vcn33_1_bt_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vcn33_1_bt don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vcn33_1_bt_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vcn33_1_bt don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vcn33_1_bt don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vcn33_1_bt don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vcn33_1_wifi_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vcn33_1_wifi don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vcn33_1_wifi_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("vcn33_1_wifi don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vcn33_1_wifi_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vcn33_1_wifi don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vcn33_1_wifi don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vcn33_1_wifi don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_buck_vpu_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("buck vpu don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_buck_vpu_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("buck vpu don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_buck_vpu_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("buck vpu don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("buck vpu don't have vol_cb\n");
		ret = -1;
	}
...
static int pmic_buck_vpu_get_voltage_sel(struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("buck vpu don't have da_vol_cb\n");
		return -1;
	}
...
static int pmic_ldo_vsram_others_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("vsram_others don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vrfck_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vrfck don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vrfck_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vrfck don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vrfck_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vrfck don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vrfck don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vrfck don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_buck_vproc2_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("buck vproc2 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_buck_vproc2_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("buck vproc2 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_buck_vproc2_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("buck vproc2 don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("buck vproc2 don't have vol_cb\n");
		ret = -1;
	}
...
static int pmic_buck_vproc2_get_voltage_sel(struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("buck vproc2 don't have da_vol_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vio28 don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vio28 don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vcn33_2_bt_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vcn33_2_bt don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vcn33_2_bt_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vcn33_2_bt don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vcn33_2_bt_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vcn33_2_bt don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vcn33_2_bt don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vcn33_2_bt don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vcn33_2_wifi_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vcn33_2_wifi don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vcn33_2_wifi_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("vcn33_2_wifi don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vcn33_2_wifi_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vcn33_2_wifi don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vcn33_2_wifi don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vcn33_2_wifi don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo va12 don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo va12 don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_buck_vproc1_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("buck vproc1 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_buck_vproc1_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("buck vproc1 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_buck_vproc1_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("buck vproc1 don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("buck vproc1 don't have vol_cb\n");
		ret = -1;
	}
...
static int pmic_buck_vproc1_get_voltage_sel(struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("buck vproc1 don't have da_vol_cb\n");
		return -1;
	}
...
static int pmic_ldo_va09_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo va09 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_va09_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo va09 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_va09_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo va09 don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo va09 don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo va09 don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vrf18 don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vrf18 don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vsram_md_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vsram_md don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vsram_md_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vsram_md don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vsram_md_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vsram_md don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vsram_md don't have vol_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vsram_md_get_voltage_sel(struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vsram_md don't have da_vol_cb\n");
		return -1;
	}
...
static int pmic_ldo_vufs_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vufs don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vufs_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vufs don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vufs_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vufs don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vufs don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vufs don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vm18_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vm18 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vm18_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vm18 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vm18_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vm18 don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vm18 don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vm18 don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vbbck_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vbbck don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vbbck_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vbbck don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vbbck_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vbbck don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vbbck don't have vol_cb\n");
		ret = -1;
	}
					...
					struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vbbck don't have da_vol_cb\n");
		ret = -1;
	} else {
		ret = -1;
		selector = (mreg->da_vol_cb)();
...
static int pmic_ldo_vsram_proc1_enable(struct regulator_dev *rdev)
{
	...
	if (mreg->en_cb != NULL)
		...
		pr_debug("ldo vsram_proc1 don't have en_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vsram_proc1_disable(struct regulator_dev *rdev)
{
	...
	if (rdev->use_count == 0) {
		...
		if (mreg->en_cb != NULL)
			...
			pr_debug("ldo vsram_proc1 don't have enable callback\n");
			ret = -1;
		}
	}
...
static int pmic_ldo_vsram_proc1_is_enabled(struct regulator_dev *rdev)
{
	...
	if (mreg->da_en_cb == NULL) {
		pr_debug("ldo vsram_proc1 don't have da_en_cb\n");
		return -1;
	}
					...
					unsigned int selector)
{
	...
	if (mreg->vol_cb != NULL)
		...
		pr_debug("ldo vsram_proc1 don't have vol_cb\n");
		ret = -1;
	}
...
static int pmic_ldo_vsram_proc1_get_voltage_sel(struct regulator_dev *rdev)
{
	...
	if (mreg->da_vol_cb == NULL) {
		pr_debug("ldo vsram_proc1 don't have da_vol_cb\n");
		return -1;
	}
...
static int pmic_buck_set_mode(struct regulator_dev *rdev, unsigned int mode)
{
	...
	case REGULATOR_MODE_FAST:
		if (curr_mode == REGULATOR_MODE_IDLE) {
			WARN_ON(1);
			pr_debug("BUCK %s is LP mode, can't FPWM\n",
				mreg->desc.name);
			return -EIO;
		}
	...
	case REGULATOR_MODE_IDLE:
		if (curr_mode == REGULATOR_MODE_FAST) {
			WARN_ON(1);
			pr_debug("BUCK %s is FPWM mode, can't enter LP\n",
				mreg->desc.name);
			return -EIO;
		}
