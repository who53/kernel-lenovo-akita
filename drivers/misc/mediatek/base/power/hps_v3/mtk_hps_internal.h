 ...
 * LOG
 */
#define hps_emerg(fmt, args...)             pr_debug("[HPS] " fmt, ##args)
#define hps_alert(fmt, args...)             pr_debug("[HPS] " fmt, ##args)
#define hps_crit(fmt, args...)              pr_debug("[HPS] " fmt, ##args)
#define hps_error(fmt, args...)             pr_debug("[HPS] " fmt, ##args)
